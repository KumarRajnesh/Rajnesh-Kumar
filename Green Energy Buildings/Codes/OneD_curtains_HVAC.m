...
for n = 1:length(Time)
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,1) > T_comfortable + T_curtains
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,2) > T_comfortable + T_curtains
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,3) > T_comfortable + T_curtains
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,4) > T_comfortable + T_curtains
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,5) > T_comfortable + T_curtains
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,6) > T_comfortable + T_curtains
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,7) > T_comfortable + T_curtains
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,9) > T_comfortable + T_curtains
...
%% Green building features: Room 10
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,10) > T_comfortable + T_curtains
...
%% Green building features: Room 11
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,11) > T_comfortable + T_curtains
...
%% Green building features: Room 13
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,13) > T_comfortable + T_curtains
...
%% Green building features: Room 14
    ...
    if Time_24(n)>=6 & Time_24(n)<=19
        ...
        if T_int(n,14) > T_comfortable + T_curtains
